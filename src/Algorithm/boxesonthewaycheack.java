...
public class boxesonthewaycheack {
	...
	//		}
	//		else {
	//			double angle=map.azimuth_elevation_dist(Ppoint, Fpoint)[0];
	//			for(int i=0;i<boxs.size();i++) {
	...
	//					if(Ppoint.ix()>maxx&&Ppoint.iy()>=miny||Ppoint.ix()<minx&&Ppoint.iy()>=miny)//להוסיף בדיקת זווית
	//						return true;
	...
	//				//				Point3D rightdown=new Point3D(boxs.get(i).getRightUp().ix(),boxs.get(i).getLeftDown().iy());
	//				//				Point3D leftup=new Point3D(boxs.get(i).getLeftDown().ix(),boxs.get(i).getRightUp().iy());
	//				//				double[] boxsangle=new double[4];
	//				//				boxsangle[0]=map.azimuth_elevation_dist(Ppoint, boxs.get(i).getLeftDown())[0];
	//				//				boxsangle[1]=map.azimuth_elevation_dist(Ppoint, boxs.get(i).getRightUp())[0];
	//				//				boxsangle[2]=map.azimuth_elevation_dist(Ppoint, rightdown)[0];
	//				//				boxsangle[3]=map.azimuth_elevation_dist(Ppoint, leftup)[0];
	//			}
	//		}
	//		return false;
	//	}
